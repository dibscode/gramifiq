...
-- Subbab 2: Macam-macam Air (10 soal)
(2, 'Berdasarkan hukum penggunaannya, air dibagi menjadi berapa macam?', 'radio', 'Dua macam', 'Tiga macam', 'Empat macam', 'Lima macam', 'Tiga macam', 10),
(2, 'Air yang suci dan mensucikan disebut...', 'radio', 'Air mutlak', 'Air musta\'mal', 'Air najis', 'Air muqayyad', 'Air mutlak', 10),
(2, 'Contoh air mutlak adalah...', 'radio', 'Air teh', 'Air hujan', 'Air kopi', 'Air sirup', 'Air hujan', 10),
(2, 'Air yang suci tapi tidak mensucikan disebut...', 'radio', 'Air mutlak', 'Air musta\'mal', 'Air muqayyad', 'Air najis', 'Air muqayyad', 10),
(2, 'Air laut termasuk jenis air...', 'radio', 'Air muqayyad', 'Air musta\'mal', 'Air mutlak', 'Air najis', 'Air mutlak', 10),
(2, 'Air yang tidak suci dan tidak mensucikan adalah...', 'radio', 'Air mutlak', 'Air musta\'mal', 'Air najis', 'Air muqayyad', 'Air najis', 10),
(2, 'Air sumur termasuk jenis...', 'radio', 'Air muqayyad', 'Air mutlak', 'Air najis', 'Air musta\'mal', 'Air mutlak', 10),
(2, 'Air yang tercampur dengan najis disebut...', 'radio', 'Air mutlak', 'Air najis', 'Air muqayyad', 'Air musta\'mal', 'Air najis', 10),
(2, 'Air es yang mencair termasuk...', 'radio', 'Air muqayyad', 'Air mutlak', 'Air najis', 'Air musta\'mal', 'Air mutlak', 10),
(2, 'Air yang boleh digunakan untuk berwudhu adalah...', 'radio', 'Air najis', 'Air muqayyad', 'Air mutlak', 'Air musta\'mal', 'Air mutlak', 10),
...
(3, 'Air hujan dapat digunakan untuk...', 'radio', 'Minum saja', 'Mandi saja', 'Wudhu dan mandi', 'Mencuci pakaian saja', 'Wudhu dan mandi', 10),
(3, 'Air yang berubah karena tanah masih...', 'radio', 'Najis', 'Tidak boleh dipakai', 'Boleh dipakai untuk bersuci', 'Menjadi muqayyad', 'Boleh dipakai untuk bersuci', 10),
(3, 'Air zamzam termasuk air...', 'radio', 'Muqayyad', 'Najis', 'Mutlak', 'Musta\'mal', 'Mutlak', 10),
(3, 'Air yang tercampur dengan minyak...', 'radio', 'Tetap suci mensucikan', 'Menjadi najis', 'Menjadi muqayyad', 'Tidak boleh dipakai', 'Menjadi muqayyad', 10),
(3, 'Minimal air yang dapat digunakan untuk wudhu adalah...', 'radio', 'Satu liter', 'Satu mud', 'Dua qullah', 'Tidak ada batas minimal', 'Satu mud', 10),
(3, 'Air yang berubah warna karena najis...', 'radio', 'Tetap suci', 'Menjadi najis', 'Menjadi muqayyad', 'Masih boleh dipakai', 'Menjadi najis', 10),
(3, 'Air sungai yang jernih termasuk...', 'radio', 'Air muqayyad', 'Air najis', 'Air mutlak', 'Air musta\'mal', 'Air mutlak', 10),
(3, 'Air yang dipakai untuk mencuci najis...', 'radio', 'Tetap suci', 'Menjadi najis', 'Menjadi muqayyad', 'Menjadi musta\'mal', 'Menjadi najis', 10),

-- Subbab 4: Air Musta'mal (10 soal)
(4, 'Air musta\'mal adalah air yang...', 'radio', 'Sudah dipakai untuk bersuci', 'Tercampur dengan najis', 'Berubah warna dan rasa', 'Terlalu sedikit', 'Sudah dipakai untuk bersuci', 10),
(4, 'Hukum air musta\'mal menurut madzhab Syafi\'i adalah...', 'radio', 'Suci dan mensucikan', 'Suci tapi tidak mensucikan', 'Najis', 'Makruh digunakan', 'Suci tapi tidak mensucikan', 10),
(4, 'Air bekas wudhu termasuk...', 'radio', 'Air mutlak', 'Air musta\'mal', 'Air najis', 'Air muqayyad', 'Air musta\'mal', 10),
(4, 'Air musta\'mal boleh digunakan untuk...', 'radio', 'Wudhu lagi', 'Minum', 'Mencuci pakaian', 'Semua jawaban benar', 'Mencuci pakaian', 10),
(4, 'Air yang menetes dari anggota wudhu...', 'radio', 'Tetap suci mensucikan', 'Menjadi musta\'mal', 'Menjadi najis', 'Menjadi muqayyad', 'Menjadi musta\'mal', 10),
(4, 'Air bekas mandi junub termasuk...', 'radio', 'Air mutlak', 'Air musta\'mal', 'Air najis', 'Air muqayyad', 'Air musta\'mal', 10),
(4, 'Perbedaan air musta\'mal dengan air najis adalah...', 'radio', 'Tidak ada perbedaan', 'Air musta\'mal masih suci', 'Air najis lebih kotor', 'Air musta\'mal lebih bersih', 'Air musta\'mal masih suci', 10),
(4, 'Air yang tersisa setelah wudhu dalam wadah...', 'radio', 'Menjadi najis', 'Tetap mutlak', 'Menjadi musta\'mal', 'Menjadi muqayyad', 'Tetap mutlak', 10),
(4, 'Hikmah larangan menggunakan air musta\'mal adalah...', 'radio', 'Menjaga kebersihan', 'Menghormati air', 'Kehati-hatian dalam bersuci', 'Semua jawaban benar', 'Semua jawaban benar', 10),
(4, 'Air musta\'mal yang bercampur dengan air mutlak...', 'radio', 'Tetap musta\'mal', 'Menjadi mutlak', 'Menjadi najis', 'Tergantung jumlahnya', 'Tergantung jumlahnya', 10),
...
(7, 'Membasuh kaki dalam wudhu sampai...', 'radio', 'Jari kaki', 'Mata kaki', 'Pergelangan kaki', 'Betis', 'Mata kaki', 10),
(7, 'Tertib dalam wudhu hukumnya...', 'radio', 'Sunnah', 'Wajib', 'Mustahab', 'Mubah', 'Wajib', 10),
(7, 'Doa setelah wudhu dimulai dengan...', 'radio', 'Asyhadu an la ilaha illallah', 'Allahumma aj\'alni minat tawwabin', 'Bismillahirrahmanirrahim', 'Subhanallahi wa bihamdihi', 'Asyhadu an la ilaha illallah', 10),
...
(12, 'Ruku dengan thuma\'ninah maksudnya...', 'radio', 'Ruku sebentar', 'Ruku dengan tenang', 'Ruku sambil berdoa', 'Ruku dengan khusyuk', 'Ruku dengan tenang', 10),
(12, 'I\'tidal adalah...', 'radio', 'Bangkit dari ruku', 'Berdiri tegak setelah ruku', 'Duduk antara dua sujud', 'Sujud pertama', 'Berdiri tegak setelah ruku', 10),
...
(13, 'Membaca ta\'awudz sebelum Al-Fatihah adalah...', 'radio', 'Wajib', 'Rukun', 'Sunnah', 'Syarat', 'Sunnah', 10),
...
(17, 'Jama\' ta\'khir adalah...', 'radio', 'Menggabungkan shalat di waktu yang pertama', 'Menggabungkan shalat di waktu yang kedua', 'Memendekkan shalat', 'Meninggalkan shalat', 'Menggabungkan shalat di waktu yang kedua', 10),
...
(19, 'Jika ruku sebelum membaca Al-Fatihah...', 'radio', 'Shalat sah', 'Shalat batal', 'Harus I\'adah', 'Tidak apa-apa', 'Shalat batal', 10),
(19, 'Jika sujud sebelum ruku...', 'radio', 'Shalat sah', 'Shalat batal', 'Harus I\'adah', 'Tidak apa-apa', 'Shalat batal', 10),
