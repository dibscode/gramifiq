...
<body class="bg-gray-50 min-h-screen flex flex-col justify-between">
    <div class="flex-1 flex flex-col items-center justify-center pt-8 pb-24">
        <div class="w-full max-w-xs bg-white rounded-lg shadow p-6">
            <h2 class="text-xl font-bold mb-4 text-center text-green-600">Konsultasi Fiqih</h2>
            <form id="chatForm" class="space-y-4">
                <input type="text" name="message" id="message" placeholder="Tulis pertanyaan fiqih..." required class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-green-300">
